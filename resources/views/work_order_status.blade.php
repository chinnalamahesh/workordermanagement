...
<html lang="{{ app()->getLocale() }}">
  ...
  <script src="https://maxcdn.bootstrapcdn.com/bootstrap/3.3.7/js/bootstrap.min.js"></script>
    ...
    <body>
        ...
        <hr>
<div class="dropdown">
  <button class="btn btn-primary dropdown-toggle" type="button" data-toggle="dropdown">Select workshop number
  <span class="caret"></span></button>
  <ul class="dropdown-menu">
   @foreach($orderStatus as $orderStas)
    <li><a href="#">{{ $orderStas->work_shop_number }}</a></li>
   @endforeach
  </ul>
</div>
    </body>
